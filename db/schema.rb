...
ActiveRecord::Schema.define(version: 20131231203339) do
  ...
  add_index "accounts", ["domain", "subdomain"], name: "index_accounts_on_domain_and_subdomain", unique: true, using: :btree
